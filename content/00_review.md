...
### 5. 12 აპრილი
- სემინარი
	- [ცვლადები, ფუნქციები](/classwork/05_drawing_structures)
- ლექცია
	- ინტერნეტი. აიტვირთება მოგვიანებით
- გაძლიერებული ჯგუფისთვის დავალება წერია სემინარის დასაწყისში
...
### 6. 19 აპრილი
- სემინარი
	- [მასივები, ობიექტები](/classwork/05_drawing_structures)
- ლექციას და სემინარის დამატებით სავარჯიშოებს ავტვირთავ მოგვიანებით
- გაძლიერებული ჯგუფის შეხვედრა: ხუთშაბათი 20:00. კონსულტაცია შეეხება ხანის აკადემიაზე ანიმაციის/ინტერაქციის ამოცანებზე კითხვებს. აუცილებელია მანამდე იმეცადინოთ, ვიდეოებს უყუროთ, სავარჯიშოები გააკეთოთ და მომზადებული კითხვებით მოხვიდეთ
